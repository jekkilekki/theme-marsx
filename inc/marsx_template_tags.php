 ...
 */
 function marsx_dynamic_copyright() {
...
if ( ! function_exists( 'marsx_post_nav' ) ) :
/**
...
function marsx_post_nav() {
	...
	<nav class="navigation post-navigation clear" role="navigation">
		<h2 class="screen-reader-text"><?php _e( 'Post navigation', 'marsx' ); ?></h2>
                ...
                <div class="nav-links">
                    ...
                    <div class="nav-previous">
                        <a href="<?php echo get_permalink( $prevID ); ?>" rel="prev">
                            ...
                            <span class="meta-nav" aria-hidden="true"><?php _e( 'Previously', 'marsx' ); ?></span>
                            <span class="screen-reader-text"><?php _e( 'Previous Post', 'marsx' ); ?></span>
                    ...
                    <div class="nav-next">
                        <a href="<?php echo get_permalink( $nextID ); ?>" rel="next">
                            ...
                            <span class="meta-nav" aria-hidden="true"><?php _e( 'Next time', 'marsx' ); ?></span>
                            <span class="screen-reader-text"><?php _e( 'Next Post', 'marsx' ); ?></span>
 ...
 */
function marsx_excerpt_more( $more ) {
    return " …";
}
add_filter( 'excerpt_more', 'marsx_excerpt_more' );


if ( ! function_exists( 'marsx_paging_nav' ) ) :
/**
...
function marsx_paging_nav() {
	...
	$links = paginate_links( array(
		...
		'prev_text' => __( '&larr; Previous', 'marsx' ),
		'next_text' => __( 'Next &rarr;', 'marsx' ),
                'type'      => 'list',
	) );
	...
	<nav class="navigation paging-navigation" role="navigation">
		<h1 class="screen-reader-text"><?php _e( 'Posts navigation', 'marsx' ); ?></h1>
                <?php echo $links; ?>
	</nav><!-- .navigation -->
	<?php
	endif;
